            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row['title'] != $current_movie) {
                        ...
                        echo "<a href='Admin update show time.php?id=" . $row['id'] . "' class='btn'>Update</a>";
                        echo "<a href='delete show time.php?id=" . $row['id'] . "' class='btn' onclick='return confirm(\"Are you sure you want to delete this showtime?\")'>Delete</a>";
