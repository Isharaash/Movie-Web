...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql_update) === TRUE) {
        ...
        echo "<script>alert('Showtime updated successfully!'); window.location.href = 'Admin  Show Time.php';</script>";
        exit();
    } else {
        ...
        <div class="form-container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $showtime_id; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <a href="Admin  Show Time.php" class="btn btn-secondary">Back</a>
                </div>
            </form>
        </div>
    </div>
